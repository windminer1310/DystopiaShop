<?php
    ...
    echo $categoryInfo['category_id'];
    echo $brandInfo['brand_id'];

    $addProduct = addProduct($product_id, $categoryInfo['category_id'], $brandInfo['brand_id'],
                                $product_name, $date_first_available, $price, $discount, $amount, $image_link, $description ,$sold);
